...
Проект `vela-test-task` представляет собой веб-приложение, разработанное с использованием React и Ant Design (судя по URL `homepage`). Для сборки и запуска проекта используется Webpack.
